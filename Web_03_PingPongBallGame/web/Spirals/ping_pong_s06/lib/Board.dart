...
class Board{
  ...
  void init() {
    ...
    //racket = new Racket(this, 250, height-RACKET_H, RACKET_W, RACKET_H);  //not touch racket
    racket = new Racket(this, 180, height-RACKET_H, RACKET_W, RACKET_H);  // touch racket
    // redraw every 10 ms
